...
## Usage(China): curl -fsSL https://gh.zhaojun.im/github.com/zhaojun1998/script/blob/main/install/zsh.sh | bash
...
GITHUB_PROXY=$(if [ $IS_CHINA_IP -eq 1 ]; then echo "https://gh.zhaojun.im/"; fi)
